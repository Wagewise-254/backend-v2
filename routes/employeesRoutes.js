...
router.get('/:companyId/employees/:employeeId/status-history', verifyToken, getEmployeeStatusHistory);
router.get('/:companyId/employees/:employeeId/contract-history', verifyToken, getEmployeeContractHistory);
...
router.post('/:companyId/employees/:employeeId/salary', verifyToken, addSalaryChange);
router.post('/:companyId/employees/:employeeId/status', verifyToken, addStatusChange);
